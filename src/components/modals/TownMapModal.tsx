...
export const TownMapModal: React.FC<TownMapModalProps> = ({ onWarp, onClose }) => {
  const locations = [
    ...
    },
    {
      ...
      desc: "High-tech facility housing Aritro's Official Trainer Card, Academic Degrees, and 8 Badges.",
      x: 21,
      y: 8,
      color: '#0284c7',
      icon: '🔬'
    ...
    },
    {
      ...
      desc: "Playable Turn-Based Gym Battle against Leader Aritro, Quarantine, and Lambda-Spark!",
      x: 16,
      y: 27,
      color: '#f59e0b',
      icon: '⚡'
